...
public class JaccardSimilarity implements SimilarityScore<Double> {
     ...
     * Does the calculation by identifying the union (characters in at least one
     * of the two sets) of the two sets and intersection (characters which are
     * present in set one which are present in set two)
     *
     * @param left first character sequence
     * @param right second character sequence
     * @return index
    ...
    public static void main(String[] args) {
        CharSequence leftS = "Hello World!";
        CharSequence rightS = "Hello World!";

        JaccardSimilarity jaccardSimilarity = new JaccardSimilarity();
        Double value = jaccardSimilarity.apply(leftS, rightS);
